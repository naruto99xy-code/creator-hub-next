      ...
      >
        ...
        <div className="p-8 md:p-10 flex flex-col justify-center">
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <a href="https://youtube.com/@next_developer?si=pLEqurp4aeWA_yIa" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-muted/50 text-muted-foreground hover:text-destructive hover:bg-muted transition-all hover:scale-110">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </a>
            <a href="https://www.instagram.com/next_developerx" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-muted/50 text-muted-foreground hover:text-pink-500 hover:bg-muted transition-all hover:scale-110">
            ...
            <a href="https://t.me/oHccFdcxrY5lN2Q9" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-muted/50 text-muted-foreground hover:text-sky-500 hover:bg-muted transition-all hover:scale-110">
          ...
          <button
            onClick={() => navigate('/')}
            className="mt-4 text-xs text-muted-foreground hover:text-foreground transition-colors text-center"
          >
            ← Back to Home
          </button>
        </div>
