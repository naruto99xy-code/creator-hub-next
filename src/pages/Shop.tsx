    ...
    <Layout>
      ...
      <section className="relative pt-28 pb-14 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <motion.div
            className="absolute top-10 left-1/3 w-80 h-80 rounded-full bg-primary/10 blur-[130px]"
            animate={{ scale: [1, 1.2, 1], opacity: [0.2, 0.4, 0.2] }}
            transition={{ duration: 7, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute bottom-0 right-1/4 w-72 h-72 rounded-full bg-cyan-500/10 blur-[110px]"
            animate={{ scale: [1, 1.3, 1], opacity: [0.15, 0.35, 0.15] }}
            transition={{ duration: 9, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
          />
          <motion.div
            className="absolute top-1/2 right-1/3 w-60 h-60 rounded-full bg-pink-500/8 blur-[100px]"
